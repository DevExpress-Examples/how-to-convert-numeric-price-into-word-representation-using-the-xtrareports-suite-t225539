Namespace WindowsFormsApplication1
    Partial Public Class XtraReport1
        ...
        Private Sub InitializeComponent()
            ...
            Me.WordsUnitPrice = New DevExpress.XtraReports.UI.CalculatedField()
            ...
            ' WordsUnitPrice
            ' 
            Me.WordsUnitPrice.DataMember = "Products"
            Me.WordsUnitPrice.FieldType = DevExpress.XtraReports.UI.FieldType.String
            Me.WordsUnitPrice.Name = "WordsUnitPrice"
            ' 
            ' xrTable1
            ' 
            ...
            ' xrTableCell3
            ' 
            Me.xrTableCell3.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() { New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Products.UnitPrice", "{0:$0.00}")})
            ...
            ' xrTableCell4
            ' 
            Me.xrTableCell4.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() { New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Products.WordsUnitPrice")})
            ...
            Me.CalculatedFields.AddRange(New DevExpress.XtraReports.UI.CalculatedField() { Me.WordsUnitPrice})
        ...
        Private WithEvents WordsUnitPrice As DevExpress.XtraReports.UI.CalculatedField
